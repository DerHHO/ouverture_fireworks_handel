...
\header {
  ...
  qrcode = \trompeteIIICQRFeuerwerksmusikHaendel
...
#(define page-breaking ly:page-turn-breaking)
  ...
  \bookOutputName "Trompete_3_C"
  \header {
    instrument = "3. Trompete (C)"
  }
...
%{</Emergency_Section>%}
      ...
      \clef "treble"
      \optionalTranspose { \transpose c c \trompeteIIINotenFeuerwerksmusikHaendel }
    }
