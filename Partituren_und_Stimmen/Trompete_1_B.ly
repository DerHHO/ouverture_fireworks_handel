...
\header {
  ...
  qrcode = \trompeteIBQRFeuerwerksmusikHaendel
...
#(include-special-characters)
  ...
  \bookOutputName "Trompete_1_B"
  \header {
    instrument = "1. Trompete (B)"
  }
  ...
  \new Staff <<
    ...
    \new Voice = "vTrompete_1_B" {
      %{<Emergency_Section>%}

%{</Emergency_Section>%}
      \compressEmptyMeasures
      \clef "treble"
      \optionalTranspose { \transpose c d \trompeteINotenFeuerwerksmusikHaendel }
    }
