...
\header {
  ...
  qrcode = \hornIIIFQRFeuerwerksmusikHaendel
...
#(include-special-characters)
  ...
  \new Staff <<
    \new Voice { 
      \optionalTranspose { \transpose c g \ablaufzeileFeuerwerksmusikHaendel }
    }
    \new Voice = "vHorn_3_F" {
      %{<Emergency_Section>%}
...
%{</Emergency_Section>%}
      ...
      \clef "treble"
      \optionalTranspose { \transpose c g \hornIINotenFeuerwerksmusikHaendel }
    }
