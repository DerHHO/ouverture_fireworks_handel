...
\header {
  ...
  qrcode = \trompeteIIIBQRFeuerwerksmusikHaendel
...
#(include-special-characters)
  ...
  \bookOutputName "Trompete_3_B"
  \header {
    instrument = "3. Trompete (B)"
  }
  ...
  \new Staff <<
    \new Voice { 
      \optionalTranspose { \transpose c d \ablaufzeileFeuerwerksmusikHaendel }
    }
    \new Voice = "vTrompete_3_B" {
      %{<Emergency_Section>%}

%{</Emergency_Section>%}
      \compressEmptyMeasures
      \clef "treble"
      \optionalTranspose { \transpose c d \trompeteIIINotenFeuerwerksmusikHaendel }
    }
